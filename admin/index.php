    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Sarnıç Şehit Uzman Çavuş Egemen Yıldız Ortaokulu</a>
            </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <a style="text-decoration: none" href="pages/makaleler">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <a href="pages/haber">
                        <div class="info-box bg-light-green hover-expand-effect">
                            ...
                            <div class="content">
                                <div class="text" style="font-size: 11px">HABER VE KÖŞE YAZILARI</div>
