    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2 style="text-align: center">İstediğiniz içeriğe tıklayarak kolayca ekleme yapabilirsiniz.</h2>
            </div>
            <!-- Body Copy -->
            <div class="row clearfix"  >
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <a style="" href="makale.php">
                        <div class="info-box-2 bg-red">
                            <div class="content">
                                <div class="text">MAKALE EKLE</div>
                            </div>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <a href="kose">
                        <div class="info-box-2 bg-purple">
                            <div class="content">
                                <div class="text">KÖŞE YAZISI EKLE</div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <a href="toplu.php">
                        <div class="info-box-2 bg-deep-purple">
                            <div class="content">
                                <div class="text">TOPLU GÖRSEL YÜKLE</div>
