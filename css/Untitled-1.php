...
$denemee = [$main_header_section_title,$filterSectionTitle,$jobListingSectionDescription,$jobListingSectionSubTitle,$jobListingSectionTitle,$career_detail_page_link];
                            ...
                            <?php  foreach ($positions_result as $key => $position_result) {
                                if ($position_result->DisplayJobMarket == "1") { ?>
                                    ...
                                    <div class="job-content">
                                        <div class="title" style="font-family: 'Jura'; height:60px; font-size:19px;text-align:center;"><?php echo $position_result->JobTitle; ?></div>
                                        
                                        <a style="max-width:100%; "  href="<?php echo $career_detail_page_link['url'] . 'career-list/?positionID=' . $position_result->Id; ?>">
                                            <button  type="button"  class="btn txt-btnn   rounded h3 btn-dark">MORE INFO</button>
                                        </a>
